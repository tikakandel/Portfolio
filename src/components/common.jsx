        ...
        <div className="row">
          ...
          <div className="row"> 
            <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-centr flex-column">
                <h1> {props.name} <strong className="brand-name"> <br /> <img src={props.brandLogo} /> {props.brandName}</strong></h1>
            ...
            <div className="col-lg-6 order-1 order-lg-2 header-img h-50">
